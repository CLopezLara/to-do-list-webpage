...
function Header() {
  ...
  return (
    <section className="header-container">
      ...
      <button className="hamburguer-button" onClick={openMenu}>
        {menu ? "X" : "☰"}
      </button>
      <nav className={`navbar-container ${menu ? "open" : ""}`}>
        <ul className="navbar-list">
          <li className="navbar-option">
            <NavLink to="/" className="nav-link" onClick={openMenu}>
              Inicio
            </NavLink>
          </li>
          <li className="navbar-option">
            <NavLink to="/tareas" className="nav-link" onClick={openMenu}>
              Tareas
            </NavLink>
          </li>
